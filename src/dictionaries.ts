...
export const paymentCancelReasonMap = {
    ...
    loan_declined:
        'Заявка на кредит или рассрочку отклонена банком. При новой попытке оплаты пользователю следует использовать другое платежное средство или обратиться в банк за уточнениями.',
